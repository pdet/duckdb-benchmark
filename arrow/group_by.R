...
x = read_csv_arrow("../data/G1_1e7_1e2_5_0.csv", schema = schema(id1=dictionary(),id2=dictionary(),id3=dictionary(),id4=int32(),id5=int32(),id6=int32(),v1=int32(),v2=int32(),v3=double()), skip=1, as_data_frame=FALSE)
print(nrow(x))
